...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
        ...
        /**
         * Creates a dependency provider for activityVersion (androidx.activity:activity-ktx)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getActivityVersion() {
            return create("activityVersion");
    }

        /**
         * Creates a dependency provider for dagger (com.google.dagger:hilt-android-compiler)
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Creates a dependency provider for fragmentVersion (androidx.fragment:fragment-ktx)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getFragmentVersion() {
            return create("fragmentVersion");
    }
        ...
        /**
         * Creates a dependency provider for viewModelLifeCycle (androidx.lifecycle:lifecycle-extensions)
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getViewModelLifeCycle() {
            return create("viewModelLifeCycle");
    }
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for instantRule (androidx.arch.core:core-testing)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getInstantRule() {
                return create("android.instantRule");
        }
            ...
            public Provider<MinimalExternalModuleDependency> getMockito() {
                return create("android.mockito");
        }

        /**
         * Returns the group of libraries at android.navigation
         */
        public AndroidNavigationLibraryAccessors getNavigation() {
            return laccForAndroidNavigationLibraryAccessors;
        }

    }

    public static class AndroidNavigationLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public AndroidNavigationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> asProvider() {
                return create("android.navigation");
        }
            ...
            public Provider<MinimalExternalModuleDependency> getHilt() {
                return create("android.navigation.hilt");
        }
    ...
    public static class AndroidxActivityLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxActivityLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for composeViewmodel (androidx.lifecycle:lifecycle-viewmodel-compose)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getComposeViewmodel() {
                return create("androidx.activity.composeViewmodel");
        }
    ...
    public static class CoroutinesLibraryAccessors extends SubDependencyFactory {
        ...
        public CoroutinesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for service (org.jetbrains.kotlinx:kotlinx-coroutines-play-services)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getService() {
                return create("coroutines.service");
        }
    ...
    public static class HiltLibraryAccessors extends SubDependencyFactory {
        ...
        public HiltLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for dependency (com.google.dagger:hilt-android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getDependency() {
                return create("hilt.dependency");
        }
    ...
    public static class ViewModelLibraryAccessors extends SubDependencyFactory {
        private final ViewModelLifecycleLibraryAccessors laccForViewModelLifecycleLibraryAccessors = new ViewModelLifecycleLibraryAccessors(owner);

        public ViewModelLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at viewModel.lifecycle
         */
        public ViewModelLifecycleLibraryAccessors getLifecycle() {
            return laccForViewModelLifecycleLibraryAccessors;
        }

    }

    public static class ViewModelLifecycleLibraryAccessors extends SubDependencyFactory {
        private final ViewModelLifecycleLivedataLibraryAccessors laccForViewModelLifecycleLivedataLibraryAccessors = new ViewModelLifecycleLivedataLibraryAccessors(owner);
        private final ViewModelLifecycleRuntimeLibraryAccessors laccForViewModelLifecycleRuntimeLibraryAccessors = new ViewModelLifecycleRuntimeLibraryAccessors(owner);
        private final ViewModelLifecycleViewmodelLibraryAccessors laccForViewModelLifecycleViewmodelLibraryAccessors = new ViewModelLifecycleViewmodelLibraryAccessors(owner);

        public ViewModelLifecycleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at viewModel.lifecycle.livedata
         */
        public ViewModelLifecycleLivedataLibraryAccessors getLivedata() {
            return laccForViewModelLifecycleLivedataLibraryAccessors;
        }

        /**
         * Returns the group of libraries at viewModel.lifecycle.runtime
         */
        public ViewModelLifecycleRuntimeLibraryAccessors getRuntime() {
            return laccForViewModelLifecycleRuntimeLibraryAccessors;
        }

        /**
         * Returns the group of libraries at viewModel.lifecycle.viewmodel
         */
        public ViewModelLifecycleViewmodelLibraryAccessors getViewmodel() {
            return laccForViewModelLifecycleViewmodelLibraryAccessors;
        }

    }

    public static class ViewModelLifecycleLivedataLibraryAccessors extends SubDependencyFactory {

        public ViewModelLifecycleLivedataLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             */
            public Provider<MinimalExternalModuleDependency> getKtx() {
                return create("viewModel.lifecycle.livedata.ktx");
        }

    }

    public static class ViewModelLifecycleRuntimeLibraryAccessors extends SubDependencyFactory {

        public ViewModelLifecycleRuntimeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             */
            public Provider<MinimalExternalModuleDependency> getKtx() {
                return create("viewModel.lifecycle.runtime.ktx");
        }

    }

    public static class ViewModelLifecycleViewmodelLibraryAccessors extends SubDependencyFactory {

        public ViewModelLifecycleViewmodelLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             */
            public Provider<MinimalExternalModuleDependency> getKtx() {
                return create("viewModel.lifecycle.viewmodel.ktx");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: assertjCore (3.19.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: coroutinesVersion (1.4.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: daggerHiltVersion (2.48)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: instantRule (2.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getInstantRule() { return getVersion("instantRule"); }
            ...
            /**
             * Returns the version associated to this alias: kotlinxCoroutinesTest (1.7.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: lifeCycleVersion (2.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: mockito (2.25.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: mockkVersion (1.13.11)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class ActivityVersionAccessors extends VersionFactory  {
        ...
        public ActivityVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: activity.version (1.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getVersion() { return getVersion("activity.version"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for roomkps to the plugin id 'com.google.devtools.ksp'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getRoomkps() { return createPlugin("roomkps"); }
